...
class Pages():
    ...
    def build_formulaire(self,nb_col,nb_ligne,list_case):
        ...
        for col in range(nb_col):
            ...
            i+=nb_ligne
        logging.info(list_layout_by_col)
    ...
    def make_image_with_table(self,img,table):
        ...
        return self.build_formulaire(2,1,[html.Img(id='import_img_detect',src=image,style={'height':'30%', 'width':'30%'}),html.Div([table],style={ 'width':'50%','height':'100%','vertical-align':'middle'})])
    ...
    def make_df_genre_to_html(self,couple):
        ...
        if data:
            ...
            list_lign.append(self.build_formulaire(2,1,[html.H6('genre',style={'textAlign': 'right'}),
            html.H6('Proba',style={'textAlign': 'left'})]))
                
           
            for line in data:
                list_lign.append(self.build_formulaire(2,1,[html.H6(line['genre'],style={'textAlign': 'right'}),
                  html.H6(line['proba'],style={'textAlign': 'left'})]))
                 
                
       
            return self.build_formulaire(1,len(list_lign),list_lign)
        else:
